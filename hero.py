...
key_turn_left = 'm'     # поворот камеры направо (а мира - налево)
key_turn_right = 'n'    # поворот камеры налево (а мира - направо) 

key_build = 'v'     # построить блок перед собой
key_destroy = 'b'   # разрушить блок перед собой
